...
from CertificateLoader import CertificateLoader
from TemplateXades import TemplateXades

class XmlSignerV3:
    def __init__(self, invoice_xml, document_type):
    ...
    def sign(self):
        ...
        properties_node = self._get_c14n_node(
            self.signature_xml.find(".//{http://uri.etsi.org/01903/v1.3.2#}SignedProperties"))
